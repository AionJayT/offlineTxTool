...
public class AionTransaction extends AbstractTransaction {
    ...
    public void setEncodedRaw(@Nonnull byte[] rawData) {
        RLPList decodedTxList = RLP.decode2(rawData);
        RLPList tx = (RLPList) decodedTxList.get(0);
    ...
    public byte[] getEncoded() {
        ...
        if (signature == null) {
            throw new NullPointerException("Encoded transaction has no signature!");
        }
